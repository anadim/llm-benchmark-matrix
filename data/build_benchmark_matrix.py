...
DATA = [
    ...
    # ── Auto-merged from extra_scores (v3): 659 entries ──
    ...
    ("claude-3.7-sonnet", "cadeval", 54, "https://willpatrick.xyz/cadevalresults_20250422_095709/"),
    ("claude-3.7-sonnet", "codeforces_rating", 1640, "https://automatio.ai/models/claude-3-7-sonnet"),
    ("claude-3.7-sonnet", "cybench", 20, "https://cybench.github.io/"),
    ...
    ("claude-3.7-sonnet", "vpct", 39, "https://cbrower.dev/vpct"),
    ...
    ("claude-opus-4", "cybench", 38, "https://cybench.github.io/"),
    ...
    ("claude-opus-4", "vpct", 33, "https://cbrower.dev/vpct"),
    ("claude-opus-4", "weirdml", 44.8, "https://htihle.github.io/weirdml.html"),
    ("claude-opus-4.1", "cybench", 42, "https://cybench.github.io/"),
    ...
    ("claude-opus-4.1", "simplebench", 60, "https://simple-bench.com/"),
    ...
    ("claude-opus-4.1", "vpct", 35, "https://cbrower.dev/vpct"),
    ...
    ("claude-opus-4.5", "cybench", 82, "https://cybench.github.io/"),
    ...
    ("claude-opus-4.5", "lech_mazur_writing", 8.2, "https://github.com/lechmazur/Writing"),
    ("claude-opus-4.5", "livebench", 76, "https://livebench.ai/"),
    ("claude-opus-4.5", "metr", 0.73, "https://metr.org/blog/2025-03-19-measuring-ai-ability-to-complete-long-tasks/"),
    ("claude-opus-4.5", "simplebench", 62, "https://lmcouncil.ai/benchmarks"),
    ("claude-opus-4.5", "vpct", 40, "https://cbrower.dev/vpct"),
    ("claude-opus-4.5", "weirdml", 39.6, "https://htihle.github.io/weirdml.html"),
    ("claude-opus-4.6", "cybench", 93, "https://cybench.github.io/"),
    ("claude-opus-4.6", "deepresearch", 55, "https://drb.futuresearch.ai"),
    ...
    ("claude-sonnet-4", "cybench", 35, "https://cybench.github.io/"),
    ...
    ("claude-sonnet-4", "vpct", 30, "https://cbrower.dev/vpct"),
    ("claude-sonnet-4", "weirdml", 43, "https://htihle.github.io/weirdml.html"),
    ...
    ("claude-sonnet-4.5", "cybench", 60, "https://cybench.github.io/"),
    ...
    ("claude-sonnet-4.5", "vpct", 38, "https://cbrower.dev/vpct"),
    ...
    ("command-a", "aider_polyglot", 12, "https://aider.chat/docs/leaderboards/#polyglot-leaderboard"),
    ...
    ("deepseek-v3.2", "lech_mazur_writing", 7.6, "https://github.com/lechmazur/Writing"),
    ...
    ("gemini-2.0-flash", "cadeval", 30, "https://willpatrick.xyz/cadevalresults_20250422_095709/"),
    ("gemini-2.0-flash", "factorio", 13, "https://jackhopkins.github.io/factorio-learning-environment/leaderboard/"),
    ...
    ("gemini-2.5-flash", "vpct", 38, "https://cbrower.dev/vpct"),
    ("gemini-2.5-pro", "aider_polyglot", 72.9, "https://aider.chat/docs/leaderboards/"),
    ...
    ("gemini-2.5-pro", "cadeval", 64, "https://willpatrick.xyz/cadevalresults_20250422_095709/"),
    ...
    ("gemini-3-pro", "vpct", 91, "https://cbrower.dev/vpct"),
    ...
    ("gpt-4.1", "cadeval", 42, "https://willpatrick.xyz/cadevalresults_20250422_095709/"),
    ...
    ("gpt-4.1", "simplebench", 27, "https://simple-bench.com/"),
    ...
    ("gpt-4.1", "vpct", 33, "https://cbrower.dev/vpct"),
    ...
    ("gpt-4.1-mini", "cadeval", 16, "https://willpatrick.xyz/cadevalresults_20250422_095709/"),
    ...
    ("gpt-4.1-nano", "weirdml", 19, "https://htihle.github.io/weirdml.html"),
    ...
    ("gpt-4.5", "vpct", 45, "https://cbrower.dev/vpct"),
    ...
    ("gpt-5", "aider_polyglot", 88, "https://openai.com/index/introducing-gpt-5/"),
    ...
    ("gpt-5", "vpct", 66, "https://cbrower.dev/vpct"),
    ...
    ("gpt-5.2", "vpct", 67, "https://cbrower.dev/vpct"),
    ...
    ("gpt-oss-120b", "weirdml", 19, "https://htihle.github.io/weirdml.html"),
    ...
    ("grok-3-beta", "aider_polyglot", 53.3, "https://aider.chat/docs/leaderboards/"),
    ...
    ("grok-4", "cybench", 43, "https://cybench.github.io/"),
    ...
    ("grok-4.1", "cybench", 39, "https://cybench.github.io/"),
    ...
    ("kimi-k2", "livebench", 48.1, "https://livebench.ai/#/"),
    ...
    ("kimi-k2.5", "weirdml", 8, "https://htihle.github.io/weirdml.html"),
    ...
    ("llama-4-maverick", "weirdml", 14, "https://htihle.github.io/weirdml.html"),
    ...
    ("minimax-m2", "simplebench", 25, "https://simple-bench.com/"),
    ...
    ("mistral-large-3", "lech_mazur_writing", 7.6, "https://github.com/lechmazur/Writing"),
    ...
    ("o3-high", "aider_polyglot", 81.3, "https://aider.chat/docs/leaderboards/"),
    ("o3-high", "brumo_2025", 95.83, "https://matharena.ai/"),
    ("o3-high", "cadeval", 74, "https://willpatrick.xyz/cadevalresults_20250422_095709/"),
    ...
    ("o3-high", "vpct", 52, "https://cbrower.dev/vpct"),
    ...
    ("o4-mini-high", "aider_polyglot", 72, "https://aider.chat/docs/leaderboards/#polyglot-leaderboard"),
    ("o4-mini-high", "arc_agi_1", 58.7, "https://arcprize.org/arc-agi/1/"),
    ("o4-mini-high", "brumo_2025", 86.67, "https://matharena.ai/"),
    ("o4-mini-high", "cadeval", 62, "https://willpatrick.xyz/cadevalresults_20250422_095709/"),
    ...
    ("qwen3-235b", "simplebench", 31, "https://simple-bench.com/"),
    ...
    ("qwen3-32b", "aider_polyglot", 40, "https://aider.chat/docs/leaderboards/#polyglot-leaderboard"),
